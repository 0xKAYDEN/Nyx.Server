...
namespace Nyx.Server.Database
{
    public class ConquerItemInformation
    {
        ...
        private void getPlusInformation(uint ID, byte Plus)
        {
            ...
            if (itemType == 14 && itemType2 != 143 && itemType2 != 142 && itemType2 != 141)
            {
                ID = (uint)(
                            (((uint)(ID / 1000)) * 1000) +
                            ((ID % 100))
            ...
            else if (itemType2 == 141 || itemType2 == 142 || itemType2 == 143 || itemType == 13 || itemType == 11 || itemType2 == 123 || itemType == 30 || itemType == 20 || itemType == 12 || itemType == 15 || itemType == 16 || itemType == 50 || itemType2 == 421 || itemType2 == 601 || itemType2 == 610 || itemType == 90)
            {
                ID = (uint)(
                            ID - (ID % 10)
                        );
            ...
            else
            {
                ...
                ID = (uint)(
                        ((head * 100000) + (head * 10000) + (head * 1000)) +
                        ((ID % 1000) - (ID % 10))
                    );
            }
        ...
        public uint CalculateDownlevel()
        {
            ...
            if (BaseInformation.ID / 1000 == 619)
            {
                return (uint)(619000 + BaseInformation.ID % 10);
            }
            if (BaseInformation.ID / 1000 == 622)
            {
                return (uint)(622010 + BaseInformation.ID % 10);
            }
            if (BaseInformation.ID / 1000 == 624)
            {
                return (uint)(624003 + BaseInformation.ID % 10);
            }
    ...
    public class ConquerItemBaseInformation
    {
        ...
        public int EarthResist,
           MetalResist, FireResist, WaterResist, WoodResist, Block, Detoxication,
             Penetration, Immunity, BreakThrough, CriticalStrike, SkillCriticalStrike;
        public uint Weight;
