namespace Nyx.Server.Database
{
    ...
    public class SkillTable
    {
        public static void removeAllSkills(Client.GameClient client)
        {
            ...
            {
                conn.Open();
                using (var cmd = new NpgsqlCommand("DELETE FROM \"skills\" WHERE \"EntityID\" = @EntityID", conn))
                {
                    cmd.Parameters.Add("@EntityID", NpgsqlDbType.Integer).Value = (int)client.Entity.UID;
                    cmd.ExecuteNonQuery();
                }
            }
        }
        ...
        public static void removeAllProfs(Client.GameClient client)
        {
            ...
            {
                conn.Open();
                using (var cmd = new NpgsqlCommand("DELETE FROM \"profs\" WHERE \"EntityID\" = @EntityID", conn))
                {
                    cmd.Parameters.Add("@EntityID", NpgsqlDbType.Integer).Value = (int)client.Entity.UID;
                    cmd.ExecuteNonQuery();
                }
        ...
        public static void LoadProficiencies(GameClient client)
        {
            ...
            if (client.Entity != null)
            {
                ...
                MySqlReader reader = new MySqlReader(new NyxSqlCommand(MySqlCommandType.SELECT).Select("profs").Where("EntityID", (long)client.Entity.UID));
                while (reader.Read())
                {
        ...
        public static void LoadProficiencies(GameClient client, NpgsqlConnection conn)
        {
            if (client.Fake) return;
            if (client.Entity != null)
            {
        ...
        public static void LoadSpells(GameClient client)
        {
            ...
            if (client.Entity != null)
            {
                ...
                MySqlReader reader = new MySqlReader(new NyxSqlCommand(MySqlCommandType.SELECT).Select("skills").Where("EntityID", (long)client.Entity.UID));
                while (reader.Read())
                {
        ...
        public static void LoadSpells(GameClient client, NpgsqlConnection conn)
        {
            if (client.Fake) return;
            if (client.Entity != null)
            {
        ...
        public static void SaveProficiencies(GameClient client)
        {
            ...
            if (((client.Entity != null) && (client.Proficiencies != null)) && (client.Proficiencies.Count != 0))
            {
                ...
                {
                    NyxSqlCommand command;
                    if (prof.Available)
                    {
                        if (prof.PreviousLevel != prof.Level)
                        {
                            command = new NyxSqlCommand(MySqlCommandType.UPDATE);
                            command.Update("profs").Set("Level", (long)prof.Level).Set("PreviousLevel", (long)prof.PreviousLevel).Set("Experience", (long)prof.Experience).Where("EntityID", (long)client.Entity.UID).And("ID", (long)prof.ID).Execute();
                        }
                    }
                    else
                    {
                        prof.Available = true;
                        command = new NyxSqlCommand(MySqlCommandType.INSERT);
        ...
        public static void SaveProficiencies(GameClient client, NpgsqlConnection conn)
        {
            if (client.Fake) return;
            if (((client.Entity != null) && (client.Proficiencies != null)) && (client.Proficiencies.Count != 0))
            {
            ...
            if (((client.Entity != null) && (client.Spells != null)) && (client.Spells.Count != 0))
            {
                foreach (ISkill skill in client.Spells.Values)
                {
                    ...
                    if (skill.Available)
                    {
                        ...
                        {
                            command = new NyxSqlCommand(MySqlCommandType.UPDATE);
                            command.Update("skills").Set("LevelHu", (long)skill.LevelHu).Set("Level", (long)skill.Level).Set("PreviousLevel", (long)skill.PreviousLevel).Set("Experience", (long)skill.Experience).Where("EntityID", (long)client.Entity.UID).And("ID", (long)skill.ID).Execute();
                        }
                    }
                    else
                    {
        ...
        public static void SaveSpells(GameClient client, NpgsqlConnection conn)
        {
            if (client.Fake) return;
            if (((client.Entity != null) && (client.Spells != null)) && (client.Spells.Count != 0))
            {
