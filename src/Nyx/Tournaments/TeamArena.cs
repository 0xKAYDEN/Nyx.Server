...
namespace Nyx.Server.Game
{
    public unsafe class TeamArena
    {
        ...
        {
            var where = ArenaStatistics.Values;
        ...
        public static class QualifierList
        {
            ...
            public static AtomicCounter GroupCounter = new AtomicCounter();
            ...
            public class QualifierParticipants
            {
                ...
                private ICollection<Client.GameClient> Players;
                private ushort id;
                private byte[] built;
                public QualifierParticipants(Client.GameClient player, KindOfParticipants kind)
                {
                    id = (ushort)kind;
                ...
                public byte[] Build(uint uid)
                {
                    if (built != null)
                    {
                        Network.SafeWriter.Write(uid, 8, built);
                        return built;
                    }
                    else
                    {
                        ...
                        strm.Close();
                        built = buf;
                        Network.SafeWriter.Write(correctPlayers, 12, buf);
                        return buf;
                    }
                }
            }
            public class QualifierGroup
            {
                ...
                public byte[] BuildWatcherPacket(ICollection<Client.GameClient> list, ushort id = 2, uint uid = 0)
                {
                    MemoryStream strm = new MemoryStream();
                    BinaryWriter wtr = new BinaryWriter(strm);
                    wtr.Write((ushort)38);
                ...
                public void Import()
                {
                    ...
                    ushort t1X = (ushort)Kernel.Random.Next(35, 70),
                           t1Y = (ushort)Kernel.Random.Next(35, 70),
                           t2X = (ushort)Kernel.Random.Next(35, 70),
                           t2Y = (ushort)Kernel.Random.Next(35, 70);

                    foreach (var team1Player in Player1.Team.Teammates)
                    {
                        if (CanFight(team1Player))
                        {
                            team1Player.Entity.Teleport(origMap.ID, dynamicMap.ID, t1X, t1Y);
                            if (team1Player.Entity.ContainsFlag((ulong)Update.Flags.Ride))
                            {
                                team1Player.Entity.RemoveFlag((ulong)Update.Flags.Ride);
                            }
                    ...
                    foreach (var team2Player in Player2.Team.Teammates)
                    {
                        ...
                        {
                            team2Player.Entity.Teleport(origMap.ID, dynamicMap.ID, t2X, t2Y);
                            if (team2Player.Entity.ContainsFlag((ulong)Update.Flags.Ride))
                            {
                                team2Player.Entity.RemoveFlag((ulong)Update.Flags.Ride);
                            }
                    ...
                    foreach (var team1Player in Player1.Team.Teammates)
                    {
                        if (team1Player.TeamQualifierGroup != null)
                        {
                            ...
                            team1Player.Entity.RemoveFlag((ulong)Network.GamePackets.Update.Flags.Ride);
                    ...
                    foreach (var team2Player in Player2.Team.Teammates)
                    {
                        if (team2Player.TeamQualifierGroup != null)
                        {
                            ...
                            team2Player.Entity.RemoveFlag((ulong)Network.GamePackets.Update.Flags.Ride);
                ...
                public void Export()
                {
                    ...
                    foreach (var team1Player in Player1.Team.Teammates)
                    {
                        if (team1Player.Map.ID == dynamicMap.ID)
                        {
                            ...
                            team1Player.Entity.RemoveFlag((ulong)Update.Flags.Poisoned);
                    ...
                    foreach (var team2Player in Player2.Team.Teammates)
                    {
                        if (team2Player.Map.ID == dynamicMap.ID)
                        {
                            ...
                            team2Player.Entity.RemoveFlag((ulong)Update.Flags.Poisoned);
                ...
                public void CheckEnd(GameClient client, bool disconnect = false)
                {
                    bool allDead = true;
                ...
                public void UpdateDamage(GameClient client, uint damage, bool otherParty = false)
                {
        ...
        public class QualifyEngine
        {
            ...
            public static void DoQuit(Client.GameClient client)
            {
                ...
                if (client.TeamQualifierGroup != null)
                {
                    if (client.Team.TeamLeader)
                    {
                        if (client.TeamQualifierGroup.Inside)
                        {
                            ...
                            client.TeamQualifierGroup.CreateTime = GameTime.Now;
                        }
                        else
                        {
                ...
                else
                {
                    ...
                    {
                        Client.GameClient other = client.TeamArenaStatistic.PlayWith;
                        ...
                        if (WaitingPlayerList.ContainsKey(client.Account.EntityID))
                        {
                            ...
                            WaitingPlayerList.Remove(client.TeamArenaStatistic.PlayWith.Account.EntityID);
                        }
                        Win(client.TeamArenaStatistic.PlayWith, client);
                        Clear(other);
                    }
            ...
            public static void CreateTeam(Team team, Client.GameClient client)
            {
                if (!client.Entity.Dead && client.Team == null)
                {
                    ...
                    lship.Count = 1;
                    client.Send(lship);
                    client.Entity.AddFlag((ulong)Update.Flags.TeamLeader);
                    client.Team = new Game.ConquerStructures.Team(client);
                    client.Team.AddLider();
            ...
            public static void DoSignup(Client.GameClient client)
            {
                ...
                {
                    client.Send(new Network.GamePackets.Message("You already joined a qualifier arena! Quit the other one and sign up again.", Color.Beige, Network.GamePackets.Message.Agate));
                    return;
                }
                ...
                if (client.Team == null)
                    CreateTeam(new Network.GamePackets.Team() { UID = client.Entity.UID, Action = Network.GamePackets.Team.Mode.Create }, client);
                if (client.Team == null)
                    return;
                client.TeamArenaStatistic.HasBox = false;
                ...
                client.TeamArenaStatistic.Status = Network.GamePackets.TeamArenaStatistic.WaitingForOpponent;
            ...
            public static void DoLeave(Client.GameClient client)
            {
                if (client.TeamWatchingGroup != null)
                {
                    ...
                    foreach (Client.GameClient client2 in client.TeamWatchingGroup.Watchers)
                        client.Send(data);
        ...
        public static void Win(Client.GameClient winner, Client.GameClient loser)
        {
            if (winner.TeamArenaStatistic.PlayWith != null && loser.TeamArenaStatistic.PlayWith != null)
            {
                ...
                if (winner.Team != null)
                {
                    if (winner.Team.Teammates != null)
                    {
                        foreach (var teammate in winner.Team.Teammates)
                        {
                            ...
                            if (teammate.ArenaStatistic.TodayWin == 7)
                            {
                                teammate.ChampionPoints += 250;
                            }
                            if (teammate.ArenaStatistic.TodayBattles == 1)
                            {
                                teammate.ChampionPoints += 100;
                                
                            }

                            if (teammate.ArenaStatistic.TodayBattles == 3)
                            {
                                teammate.ChampionPoints += 150;
                                
                            }

                            if (teammate.ArenaStatistic.TodayBattles == 5)
                            {
                                teammate.ChampionPoints += 200;
                                
                            }

                            if (teammate.ArenaStatistic.TodayBattles == 7)
                            {
                                teammate.ChampionPoints += 200;
                            ...
                            if (teammate.TeamArenaStatistic.TodayWin == 9)
                            {
                                ...
                                teammate.Send(new Network.GamePackets.Message("You won a fight in the Team Qualifier, and received an Arena Pack!", System.Drawing.Color.Red, Message.System));
                            }
                            ...
                            teammate.Activenes.SendSinglePacket(teammate, Activeness.Types.TeamQualiferTask, (byte)winner.TeamArenaStatistic.TodayBattles);
                        }
                    }
                }
                if (loser.Team != null)
                ...
                if (WaitingPlayerList.ContainsKey(loser.Account.EntityID))
                    WaitingPlayerList.Remove(loser.Account.EntityID);
                if (WaitingPlayerList.ContainsKey(winner.Account.EntityID))
                ...
                foreach (var client in Kernel.GamePool.Values)
                    client.Send(new Network.GamePackets.Message(builder.ToString(), System.Drawing.Color.Red, Network.GamePackets.Message.ArenaQualifier));
        ...
        public static void Clear(Client.GameClient client)
        {
            ...
            teamarena_stat.AcceptBoxShow = DateTime.Now;
                ...
                if (CanJoin(Challanger, Now))
                {
                    ...
                    for (; j != jEnd; j += jPlus)
                    {
                        ...
                        if (CanJoin(Challanged, Now))
                        {
                            ...
                            {
                                Challanged.TeamArenaStatistic.AcceptBoxShow = Challanger.TeamArenaStatistic.AcceptBoxShow = DateTime.Now;
            ...
            foreach (var Challanger in WaitingPlayerList.Values)
            {
                ...
                if (Challanger != null)
                {
                    ...
                    if (Challanger.TeamArenaStatistic.HasBox)
                    {
                        ...
                        {
                            Client.GameClient Challanged = Challanger.TeamArenaStatistic.PlayWith;
                            if (Challanged != null)
                            {
                                if (Challanged.Team == null) continue;
                                if (Challanged.Team.Teammates == null) continue;
                                if (Challanged.TeamArenaStatistic.PlayWith != null && Challanged.TeamQualifierGroup == null)
                                {
                                    ...
                                    {
                                        if (Challanged.Entity.MapID == 1081 || Challanged.Entity.ContainsFlag2((ulong)Update.Flags2.SoulShackle))
                                        {
                                            Arena.QualifyEngine.DoQuit(Challanged);
                                            continue;
                                        }
                                        if (Challanger.Entity.MapID == 1081 || Challanger.Entity.ContainsFlag2((ulong)Update.Flags2.SoulShackle))
                                        {
                                    ...
                                    else if (DateTime.Now > Challanger.TeamArenaStatistic.AcceptBoxShow.AddSeconds(59))
                                    {
        ...
        public static void PickUpTeams()
        {
            if (PlayerList.Count >= 2)
            {
                ...
                int length;
                int num4;
                GameClient[] array = new GameClient[PlayerList.Count];
                ...
                while (num != length)
                {
                    GameClient client = array[num];
                    if (CanJoin(client, now))
                    {
                        while (num2 != num4)
                        {
                            GameClient OpponentTeam = array[num2];
                            if (CanJoin(OpponentTeam, now))
                            {
                                OpponentTeam.TeamArenaStatistic.AcceptBoxShow = client.TeamArenaStatistic.AcceptBoxShow = DateTime.Now;
                                ...
                                PlayerList.Remove(OpponentTeam.Account.EntityID);
                                PlayerList.Remove(client.Account.EntityID);
                                WaitingPlayerList.Add(OpponentTeam.Account.EntityID, OpponentTeam);
                                WaitingPlayerList.Add(client.Account.EntityID, client);
                            }
                            num2 += num6;
                        }
                    }
        ...
        public static void Reset()
        {
            ...
            AcceptingNewBattles = ((Now64.Hour >= 8 && Now64.Hour < 12) || (Now64.Hour >= 13 && Now64.Hour < 23));
        ...
        private static bool CanFight(Client.GameClient client)
        {
            if (client.ArenaPoints <= 0) return false;
            if (client.Entity.Level <= 70) return false;
            if (client.Entity.ContainsFlag2((ulong)Update.Flags2.SoulShackle)) return false;
        ...
        private static bool CanJoin(Client.GameClient client, DateTime now)
        {
            if (client != null)
            {
                if (client.TeamArenaStatistic.PlayWith == null)
                {
                    if (client.TeamQualifierGroup == null)
                    {
                        if (!client.Entity.ContainsFlag((ulong)Update.Flags.TeamLeader))
                            return false;
                        if (!CanFight(client))
                            return false;
