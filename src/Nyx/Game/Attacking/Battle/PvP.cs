                ...
                case Attack.Melee:
                    {
                        ...
                        Nyx.Server.Game.Attacking.Calculate.Refinary(Attacker, Target, ref Damage, ref Packet, false);
                ...
                case Attack.Magic:
                    {
                        ...
                        Nyx.Server.Game.Attacking.Calculate.Refinary(Attacker, Target, ref Damage, ref Packet, true);
