...
namespace Nyx.Server
{
    public partial class MyMath
    {
        public static Int32 GetDamageEntity2Monster(Entity Attacker, Entity Monster, uint AtkType, ref Attack Packet)
        {
                ...
                case Attack.Melee:
                    {
                        ...
                        Nyx.Server.Game.Attacking.Calculate.Refinary(Attacker, Monster, ref Damage, ref Packet, false);
                ...
                case Attack.Magic:
                    {
                        ...
                        Damage = AdjustDamageEntity2Monster(Damage, Attacker, Monster);
                        Nyx.Server.Game.Attacking.Calculate.Refinary(Attacker, Monster, ref Damage, ref Packet, true);
            ...
            if (Monster.Name == "GoldenOctopus" || Monster.Name == "SilverOctopus")
                return 1;
