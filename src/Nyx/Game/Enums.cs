namespace Nyx.Server.Game
{
    public static class Enums
    {
        ...
        public static int ChiMinValues(ChiAttribute attribute)
        {
            switch (attribute)
            {
                case ChiAttribute.CriticalStrike:
                    return 10;
                case ChiAttribute.SkillCriticalStrike:
                    return 10;
                case ChiAttribute.Immunity:
                    return 10;
                case ChiAttribute.Breakthrough:
                    return 10;
                case ChiAttribute.Counteraction:
                    return 10;
                case ChiAttribute.HPAdd:
                    return 1000;
                case ChiAttribute.AddAttack:
                    return 500;
                case ChiAttribute.AddMagicAttack:
                    return 500;
                case ChiAttribute.AddMagicDefense:
                    return 50;
                case ChiAttribute.PhysicalDamageIncrease:
                    return 50;
                case ChiAttribute.PhysicalDamageDecrease:
                    return 50;
                case ChiAttribute.MagicDamageIncrease:
                    return 50;
                case ChiAttribute.MagicDamageDecrease:
                    return 50;
                default:
                    return 10;
            }
        ...
        public enum ChampionIDs : uint
        { QualifierList = 6, ShowPlayerRankList = 10 }
