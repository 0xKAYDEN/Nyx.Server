...
namespace Nyx.Server.Game
{
    public class Calculations
    {
        ...
        {
            if (Nyx.Server.Game.GuildWar.RightGate.Mesh == (270 + Nyx.Server.Game.GuildWar.RightGate.Mesh % 10) && oldX >= Nyx.Server.Game.GuildWar.RightGate.X && client.Entity.X <= Nyx.Server.Game.GuildWar.RightGate.X && client.Entity.Y < Nyx.Server.Game.GuildWar.LeftGate.Y)
            {
            ...
            if (Nyx.Server.Game.GuildWar.LeftGate.Mesh == (240 + Nyx.Server.Game.GuildWar.LeftGate.Mesh % 10) && oldY >= Nyx.Server.Game.GuildWar.LeftGate.Y && client.Entity.Y <= Nyx.Server.Game.GuildWar.LeftGate.Y && client.Entity.X < Nyx.Server.Game.GuildWar.RightGate.X)
            {
                client.Entity.X = oldX;
                client.Entity.Y = oldY;
                client.Disconnect();
