...
namespace Nyx.Server.Game.ConquerStructures.Society
{
    public class Arsenal
    {
        public class ArsenalItem
        {
            ...
            public ArsenalItem(Arsenal super, ConquerItem item, Client.GameClient client)
            {
                Super = super;
                UID = item.UID;
                Update(item, client);
            ...
            public void Update(ConquerItem item, Client.GameClient client)
            {
        ...
        public void AddItem(ConquerItem item, Client.GameClient client)
        {
        ...
        public void RemoveItem(ArsenalItem item, Client.GameClient client)
        {
        ...
        public void RemoveItem(ConquerItem item, Client.GameClient client)
        {
            if (ItemDictionary.ContainsKey(item.UID))
        ...
        public void Load(BinaryReader reader)
        {
            ...
            {
                EnhancementExpDate = DateTime.MinValue;
            }
            try
            {
            ...
            {
                // Corrupted data, skip remaining items
            }
            OrderList();
            if (Enhancement != 0)
