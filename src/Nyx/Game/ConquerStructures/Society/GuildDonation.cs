...
namespace Nyx.Server.Game.ConquerStructures.Society
{
    ...
    {
        #region Roses
        public static byte[] BuildPacketRedRosseDonationPage1(Client.GameClient client, byte Subtype, byte pagenumber)
        {
        ...
        public static byte[] BuildPacketRedRossePage2(Client.GameClient client, byte Subtype, byte pagenumber)
        {
        ...
        #endregion
        #region Lilise
        public static byte[] BuildPacketLiliseDonationPage1(Client.GameClient client, byte Subtype, byte pagenumber)
        {
            MemoryStream strm = new MemoryStream();
            BinaryWriter wtr = new BinaryWriter(strm);
            wtr.Write((ushort)0);
        ...
        public static byte[] BuildPacketLiliesPage2(Client.GameClient client, byte Subtype, byte pagenumber)
        {
        ...
        #endregion
        #region Tuplise
        public static byte[] BuildPacketTupliseDonationPage1(Client.GameClient client, byte Subtype, byte pagenumber)
        {
            MemoryStream strm = new MemoryStream();
            BinaryWriter wtr = new BinaryWriter(strm);
            wtr.Write((ushort)0);
        ...
        public static byte[] BuildPacketTuplisePage2(Client.GameClient client, byte Subtype, byte pagenumber)
        {
        ...
        #endregion
        #region Orchades
        public static byte[] BuildPacketOrchadesDonationPage1(Client.GameClient client, byte Subtype, byte pagenumber)
        {
            MemoryStream strm = new MemoryStream();
            BinaryWriter wtr = new BinaryWriter(strm);
            wtr.Write((ushort)0);
        ...
        public static byte[] BuildPacketOrchadesPage2(Client.GameClient client, byte Subtype, byte pagenumber)
        {
        ...
        public static byte[] BuildPacketGuideDonationPage1(Client.GameClient client, byte Subtype, byte pagenumber)
        {
            MemoryStream strm = new MemoryStream();
            BinaryWriter wtr = new BinaryWriter(strm);
            wtr.Write((ushort)0);
        ...
        public static byte[] BuildPacketGuidePage2(Client.GameClient client, byte Subtype, byte pagenumber)
        {
        ...
        #endregion
        #region CpDoantion
        public static byte[] BuildPacketCpDonationPage1(Client.GameClient client, byte Subtype, byte pagenumber)
        {
            MemoryStream strm = new MemoryStream();
            BinaryWriter wtr = new BinaryWriter(strm);
            wtr.Write((ushort)0);
        ...
        public static byte[] BuildPacketCpsDonationPage2(Client.GameClient client, byte Subtype, byte pagenumber)
        {
        ...
        public static byte[] BuildPacketArsenalDonationPage1(Client.GameClient client, byte Subtype, byte pagenumber)
        {
            MemoryStream strm = new MemoryStream();
            BinaryWriter wtr = new BinaryWriter(strm);
            wtr.Write((ushort)0);
        ...
        public static byte[] BuildPacketArsenalDonationPage2(Client.GameClient client, byte Subtype, byte pagenumber)
        {
        ...
        #endregion
        #region PkDoantion
        public static byte[] BuildPacketPkDonationPage1(Client.GameClient client, byte Subtype, byte pagenumber)
        {
            MemoryStream strm = new MemoryStream();
            BinaryWriter wtr = new BinaryWriter(strm);
            wtr.Write((ushort)0);
        ...
        public static byte[] BuildPacketPkDonationPage2(Client.GameClient client, byte Subtype, byte pagenumber)
        {
        ...
        public static byte[] BuildPacketSilverDonationPage1(Client.GameClient client, byte Subtype, byte pagenumber)
        {
            MemoryStream strm = new MemoryStream();
            BinaryWriter wtr = new BinaryWriter(strm);
            wtr.Write((ushort)0);
        ...
        public static byte[] BuildPacketSilverDonationPage2(Client.GameClient client, byte Subtype, byte pagenumber)
        {
        ...
        public static byte[] BuildPacketTotalDoantionPage1(Client.GameClient client, byte Subtype, byte pagenumber)
        {
        ...
        public static byte[] BuildPacketTotalDoantionPage2(Client.GameClient client, byte Subtype, byte pagenumber)
        {
        ...
        public static byte[] BuildPacketTotalDoantionPage3(Client.GameClient client, byte Subtype, byte pagenumber)
        {
        ...
        public static byte[] BuildPacketTotalDoantionPage4(Client.GameClient client, byte Subtype, byte pagenumber)
        {
        ...
        public static byte[] BuildPacketTotalDoantionPage5(Client.GameClient client, byte Subtype, byte pagenumber)
        {
        ...
        public static byte[] BuildPacketTotalDoantionPage6(Client.GameClient client, byte Subtype, byte pagenumber)
        {
        ...
        public static byte[] BuildPacketTotalDoantionPage7(Client.GameClient client, byte Subtype, byte pagenumber)
        {
        ...
        public static byte[] BuildPacketTotalDoantionPage8(Client.GameClient client, byte Subtype, byte pagenumber)
        {
        ...
        public static byte[] BuildPacketTotalDoantionPage9(Client.GameClient client, byte Subtype, byte pagenumber)
        {
        ...
        public static byte[] BuildPacketTotalDoantionPage10(Client.GameClient client, byte Subtype, byte pagenumber)
        {
