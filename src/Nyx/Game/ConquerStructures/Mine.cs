...
namespace Nyx.Server.Game.ConquerStructures
{
    public class Mining
    {
        public static void Mine(Client.GameClient client)
        {
        ...
        static void Mine(uint GemID, uint GemID2, uint GemID3, uint GemID4, uint Ore1, uint Ore2, uint Ore3, uint Ore4, Client.GameClient client)
        {
            if (client.Inventory.Count <= 39)
            {
                if (Ore1 != 0 && Kernel.Rate(30))//ores type 1
                {
                    if (Ore1 != 1072031) { Ore1 += (uint)Kernel.Random.Next(0, 9); }
                ...
                if (Ore2 != 0 && Kernel.Rate(20))//ores type 2
                {
                    if (Ore2 != 1072031) { Ore2 += (uint)Kernel.Random.Next(0, 9); }
                ...
                if (Ore3 != 0 && Kernel.Rate(25))//ores type 3
                {
                    if (Ore3 != 1072031) { Ore3 += (uint)Kernel.Random.Next(0, 9); }
                ...
                if (Ore4 != 0 && Kernel.Rate(30))//ores type 4
                {
                    if (Ore4 != 1072031) { Ore4 += (uint)Kernel.Random.Next(0, 9); }
                ...
                if (GemID != 0 && Kernel.Rate(5))
                {
                    if (Kernel.Rate(1, 250))
                        GemID4 += 1;
                    else if (Kernel.Rate(1, 100))
                        GemID4 += 2;
