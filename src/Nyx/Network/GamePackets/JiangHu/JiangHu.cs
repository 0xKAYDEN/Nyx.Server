...
namespace Nyx.Server.Game
{
    ...
    public class JiangHu : IJiangHu
    {
        ...
        byte jlevel = 0;
        public void CreateRollValue(Client.GameClient client, byte mStar, byte mStage, bool super = false, byte Higher = 0)
        {
        ...
        private static bool CanKeepChiPower(JiangStages strct, GetNewStar nstar, GameClient client)
        {
        ...
        public void ApplayNewStar(Client.GameClient client)
        {
            if (MyNewStart == null)
                return;
        ...
        public void ResetDay(Client.GameClient client)
        {
            RoundBuyPoints = 0;
            FreeTimeTodeyUsed = 0;
        ...
        public void OnloginClient(Client.GameClient client)
        {
            SendStatus(client, client);
            SendStatusMode(client, true);
            TimerStamp = DateTime.Now;
        }
        public void SendStatusMode(Client.GameClient client, bool justlogen = false)
        {
        ...
        public void TheadTime(Client.GameClient client)
        {
            try
            {
                if (client == null)
        ...
        public void GetKill(Client.GameClient attacker, JiangHu attacked)
        {
        ...
        public void GetReward(Client.GameClient client)
        {
        ...
        public void SendInfo(Client.GameClient client, byte mode = 1, params string[] data)
        {
            lock (sync)
            {
                try
        ...
        public void SendStatus(Client.GameClient client, Client.GameClient Attacked)
        {
            try
            {
        ...
        public void UpdateStundyPoints(Client.GameClient client, ushort amount)
        {
