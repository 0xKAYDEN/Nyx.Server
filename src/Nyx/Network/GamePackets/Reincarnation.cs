...
namespace Nyx.Server.Game.Features.Reincarnation
{
    ...
    public class Reincarnation
    {
        ...
        private SafeDictionary<ushort, Nyx.Server.Interfaces.ISkill> RemoveSkill = null;
        private SafeDictionary<ushort, Nyx.Server.Interfaces.ISkill> Addskill = null;
        ...
        public Reincarnation(Client.GameClient client, byte new_class)
        {
            if (client.Entity.Level < 130)
                return;
            _client = client;
            RemoveSkill = new SafeDictionary<ushort, Nyx.Server.Interfaces.ISkill>(500);
            Addskill = new SafeDictionary<ushort, Nyx.Server.Interfaces.ISkill>(500);
            ...
            client.Spells.Clear();
            client.Spells = new SafeDictionary<ushort, Nyx.Server.Interfaces.ISkill>(100);
            switch (client.Entity.FirstRebornClass)
            {
                case 15:
                    {
                        Add(Nyx.Server.Game.Enums.SkillIDs.Cyclone);
                        Add(Nyx.Server.Game.Enums.SkillIDs.Hercules);
                        Add(Nyx.Server.Game.Enums.SkillIDs.SpiritHealing);
                        Add(Nyx.Server.Game.Enums.SkillIDs.Robot);
                        Add(Nyx.Server.Game.Enums.SkillIDs.SuperCyclone);
                        Add(Nyx.Server.Game.Enums.SkillIDs.FatalCross);
                        Add(Nyx.Server.Game.Enums.SkillIDs.MortalStrike);
                        Add(Nyx.Server.Game.Enums.SkillIDs.BreathFocus);
                        break;
                    }
                case 25:
                    {
                        Add(Nyx.Server.Game.Enums.SkillIDs.SuperMan);
                        Add(Nyx.Server.Game.Enums.SkillIDs.Dash);
                        Add(Nyx.Server.Game.Enums.SkillIDs.Shield);
                        break;
                    }
                case 45:
                    {
                        Add(Nyx.Server.Game.Enums.SkillIDs.Intensify);
                        Add(Nyx.Server.Game.Enums.SkillIDs.Scatter);
                        Add(Nyx.Server.Game.Enums.SkillIDs.RapidFire);
                        Add(Nyx.Server.Game.Enums.SkillIDs.XPFly);
                        Add(Nyx.Server.Game.Enums.SkillIDs.AdvancedFly);
                        break;
                    }
                case 55:
                    {
                        Add(Nyx.Server.Game.Enums.SkillIDs.FatalStrike);
                        Add(Nyx.Server.Game.Enums.SkillIDs.ShurikenVortex);
                        Add(Nyx.Server.Game.Enums.SkillIDs.ToxicFog);
                        Add(Nyx.Server.Game.Enums.SkillIDs.TwofoldBlades);
                        Add(Nyx.Server.Game.Enums.SkillIDs.PoisonStar);
                        Add(Nyx.Server.Game.Enums.SkillIDs.TwilightDance);
                        Add(Nyx.Server.Game.Enums.SkillIDs.SuperTwofoldBlade);
                        Add(Nyx.Server.Game.Enums.SkillIDs.FatalSpin);

                        break;
                    }
                case 65:
                    {
                        Add(Nyx.Server.Game.Enums.SkillIDs.RadiantPalm);
                        Add(Nyx.Server.Game.Enums.SkillIDs.WhirlWindKick);
                        Add(Nyx.Server.Game.Enums.SkillIDs.TripleAttack);
                        Add(Nyx.Server.Game.Enums.SkillIDs.Oblivion);
                        Add(Nyx.Server.Game.Enums.SkillIDs.Serenity);
                        Add(Nyx.Server.Game.Enums.SkillIDs.Compassion);
                        Add(Nyx.Server.Game.Enums.SkillIDs.TyrantAura);
                        Add(Nyx.Server.Game.Enums.SkillIDs.TyrantAura);
                        Add(Nyx.Server.Game.Enums.SkillIDs.DeflectionAura);
                        break;
                    }
                case 75:
                    {
                ...
                case 85:
                    {
                        Add(Nyx.Server.Game.Enums.SkillIDs.SpeedKick);
                        Add(Nyx.Server.Game.Enums.SkillIDs.ViolentKick);
                        Add(Nyx.Server.Game.Enums.SkillIDs.StormKick);
                        Add(Nyx.Server.Game.Enums.SkillIDs.CrackingSwip);
                        Add(Nyx.Server.Game.Enums.SkillIDs.SplittingSwipe);
                        Add(Nyx.Server.Game.Enums.SkillIDs.DragonSwing);
                        Add(Nyx.Server.Game.Enums.SkillIDs.DragonPunch);
                        Add(Nyx.Server.Game.Enums.SkillIDs.DragonSlash);
                        Add(Nyx.Server.Game.Enums.SkillIDs.DragonFlow);
                        Add(Nyx.Server.Game.Enums.SkillIDs.DragonRoar);
                        Add(Nyx.Server.Game.Enums.SkillIDs.DragonCyclone);
                        Add(Nyx.Server.Game.Enums.SkillIDs.AirKick);
                        Add(Nyx.Server.Game.Enums.SkillIDs.AirSweep);
                        Add(Nyx.Server.Game.Enums.SkillIDs.AirRaid);
                        break;
                    }
                case 135:
                    {
                        Add(Nyx.Server.Game.Enums.SkillIDs.Thunder);
                        Add(Nyx.Server.Game.Enums.SkillIDs.WaterElf);
                        Add(Nyx.Server.Game.Enums.SkillIDs.Cure);
                        Add(Nyx.Server.Game.Enums.SkillIDs.Lightning);
                        Add(Nyx.Server.Game.Enums.SkillIDs.Volcano);
                        Add(Nyx.Server.Game.Enums.SkillIDs.Pray);
                        Add(Nyx.Server.Game.Enums.SkillIDs.AdvancedCure);
                        Add(Nyx.Server.Game.Enums.SkillIDs.Meditation);
                        Add(Nyx.Server.Game.Enums.SkillIDs.Stigma);
                        break;
                    }
                case 140:
                    {
                        ...
                        Add(Nyx.Server.Game.Enums.SkillIDs.Cure);
                        Add(Nyx.Server.Game.Enums.SkillIDs.Lightning);
                        Add(Nyx.Server.Game.Enums.SkillIDs.Tornado);
                        Add(Nyx.Server.Game.Enums.SkillIDs.FireCircle);
                        Add(Nyx.Server.Game.Enums.SkillIDs.FireMeteor);
                        Add(Nyx.Server.Game.Enums.SkillIDs.FireRing);
                        break;
                    }
            }
            ...
            Add(Nyx.Server.Game.Enums.SkillIDs.Bless);

            Addskill.Clear();
            Addskill = new SafeDictionary<ushort, Nyx.Server.Interfaces.ISkill>(100);
            ...
            Addskill.Clear();
            Addskill = new SafeDictionary<ushort, Nyx.Server.Interfaces.ISkill>(20);
            ...
            {
                Add(Nyx.Server.Game.Enums.SkillIDs.DragonWhirl);
            }
            if (client.Entity.FirstRebornClass == 85 && client.Entity.SecondRebornClass == 85 &&
                client.Entity.Class == 81)
            {
                Add(Nyx.Server.Game.Enums.SkillIDs.DragonFury);
            }
            if (client.Entity.FirstRebornClass == 25 && client.Entity.SecondRebornClass == 25 &&
                client.Entity.Class == 21)
            {
                Add(Nyx.Server.Game.Enums.SkillIDs.Perseverance);
            }
            if (client.Entity.FirstRebornClass == 45 && client.Entity.SecondRebornClass == 45 &&
                client.Entity.Class == 41)
            {
                Add(Nyx.Server.Game.Enums.SkillIDs.StarArrow);
            }
            if (client.Entity.FirstRebornClass == 55 && client.Entity.SecondRebornClass == 55 &&
                client.Entity.Class == 55)
            {
                Add(Nyx.Server.Game.Enums.SkillIDs.PoisonStar);
                Add(Nyx.Server.Game.Enums.SkillIDs.CounterKill);
            }
            if (client.Entity.FirstRebornClass == 65 && client.Entity.SecondRebornClass == 65 &&
                client.Entity.Class == 61)
            {
                Add(Nyx.Server.Game.Enums.SkillIDs.soulshackle);
            }
            if (client.Entity.FirstRebornClass == 135 && client.Entity.SecondRebornClass == 135 &&
                client.Entity.Class == 132)
            {
                Add(Nyx.Server.Game.Enums.SkillIDs.AzureShield);
            }
            if (client.Entity.FirstRebornClass == 145 && client.Entity.SecondRebornClass == 145 &&
                client.Entity.Class == 142)
            {
                Add(Nyx.Server.Game.Enums.SkillIDs.HeavenBlade);
            }
            ...
            foreach (var player in Kernel.GamePool.Values)
                player.Send(new Network.GamePackets.Message(client.Entity.Name + " has been Reincarnated!", System.Drawing.Color.WhiteSmoke, 2000));
        }

        private void Add(Nyx.Server.Game.Enums.SkillIDs S)
        {
        ...
        private void WontAdd(Nyx.Server.Game.Enums.SkillIDs S)
        {
    ...
    public class Reincarnate
    {
        ...
        public Reincarnate(Entity _Entity, byte _class)
        {
            ...
            //States = new Client.GameClient[Program.SafeReturn().Count];
        ...
        private void doIt()
        {
            ...
            {
                client.Send(
                    new Nyx.Server.Network.GamePackets.Message(
